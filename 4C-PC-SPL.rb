...
def _spl_power_cycles( power_cycle_count: nil , voltage_5v: 3.3 , voltage_12v: 12.0 , compare: true , ttr: 0 )
	...
	1.upto( power_cycle_count ) do ; $ANGEL.spl_workload( pwr_5v: voltage_5v , pwr_12v: voltage_12v , ttr: ttr , spl_on: 60 , spl_off: 30 , compare: compare ) ; end
end
